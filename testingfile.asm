...
.data
	...
	number_one:	.word	3360, 3232,3104, 2976, 2848
...
SET_S2_NUMBER_ZERO:
	...
	la $t4, number_zero
	lw $t5, 0($t4)
	add $t5, $t5, 0 	# change num to follow digit
	add $t5, $t5, $t0
	sw $t8, 0($t5)
	lw $t5, 4($t4)
	add $t5, $t5, 0 	# change num to follow digit
...
SET_S1_NUMBER_ZERO:
	...
	la $t4, number_zero
	lw $t5, 0($t4)
	add $t5, $t5, 24 	# change num to follow digit
	add $t5, $t5, $t0
	sw $t8, 0($t5)
	lw $t5, 4($t4)
	add $t5, $t5, 24 	# change num to follow digit
